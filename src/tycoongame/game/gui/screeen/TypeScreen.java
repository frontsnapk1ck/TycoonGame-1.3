...
public class TypeScreen extends ScreenFramework {
    ...
    protected void whenTypeSelected(BuildingType buildingType )
    {
        TypeViewEvent event = new TypeViewEvent( buildingType.toString() );
        for (TypeListner o : this.listeners)
            o.onTypeView(event);
    }
